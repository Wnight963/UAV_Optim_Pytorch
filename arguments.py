...
def parse_args():
    ...
    # environment  simple_adversary  simple_collaborative_comm
    parser.add_argument("--scenario_name", type=str, default="simple_collaborative_comm", help="name of the scenario script")
    parser.add_argument("--start_time", type=str, default=time_now, help="the time when start the game")
    parser.add_argument("--per_episode_max_len", type=int, default=100, help="maximum episode length")
    parser.add_argument("--max_episode", type=int, default=150000, help="maximum episode length")
    parser.add_argument("--num-adversaries", type=int, default=0, help="number of adversaries")

    # core training parameters
    parser.add_argument("--exp_name", type=str, default="exp_torch_8",help="name of the experiment")
    parser.add_argument("--device", default=device, help="torch device ")
    parser.add_argument("--learning_start_step", type=int, default=0, help="learning start steps")
    ...
    parser.add_argument("--old_model_name", type=str, default="models/exp_torch_8/21_0406_0824_12120000/", \
            help="directory in which training state and model are loaded")
    # evaluation
    parser.add_argument("--restore", action="store_true", default=True)
    parser.add_argument("--display", action="store_true", default=True)
    parser.add_argument("--test", action="store_true", default=True)
    parser.add_argument("--restore_idxs", type=list, default=[0,1,2])
