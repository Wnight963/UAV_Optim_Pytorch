...
class openai_critic(abstract_agent):
    ...
    def reset_parameters(self):
        ...
        nn.init.xavier_uniform_(self.linear_c1.weight, gain=nn.init.calculate_gain('relu'))
        nn.init.xavier_uniform_(self.linear_c2.weight, gain=nn.init.calculate_gain('relu'))
        nn.init.xavier_uniform_(self.linear_c.weight, gain=nn.init.calculate_gain('relu'))
...
class openai_actor(abstract_agent):
    ...
    def reset_parameters(self):
        ...
        gain_tanh = nn.init.calculate_gain('tanh')
        gain = nn.init.calculate_gain('relu')
        nn.init.xavier_uniform_(self.linear_a1.weight, gain=nn.init.calculate_gain('relu'))
        nn.init.xavier_uniform_(self.linear_a2.weight, gain=nn.init.calculate_gain('relu'))
        nn.init.xavier_uniform_(self.linear_a.weight, gain=nn.init.calculate_gain('relu'))
